...
// ===== HP-BASED TIERS =====
// === Rarity tiers based on observed distribution ===
// Non-legend observed range with current HP table:
const NONLEG_HP_MIN = 526;   // lowest non-legend we measured
const NONLEG_HP_MAX = 887;   // highest non-legend we measured

// 25 Legend 1/1s are hard-override:
const LEGEND_HP = 1000;

/**
 * Map HP to a rarity label.
 * - "Mythic" = the 1/1 Legends (HP = 1000 only)
...
function hpToTierLabel(hp) {
  if (hp >= LEGEND_HP) return 'Mythic'; // the 25 1/1s only

  // Normalize non-legend HP into 0..1 based on observed min/max
  const range = Math.max(1, NONLEG_HP_MAX - NONLEG_HP_MIN); // guard divide-by-zero
  const n = Math.max(0, Math.min(1, (hp - NONLEG_HP_MIN) / range));

  // Tight top bucket (bigger visual gap at the top as requested)
  if (n >= 0.95) return 'Legendary';   // ~top 5% of non-legend
  if (n >= 0.70) return 'Rare';        // ~70–95th percentile
  if (n >= 0.45) return 'Uncommon';    // ~45–70th percentile
  return 'Common';                     // bottom ~45%
}
...
const HP_TABLE = {
  ...
  "Background": {
    ...
    "Purple Boom": 180,
    "Green Splash": 179,
    "Light Blue Splash": 178,
    "Dark Blue Splash": 177,
    "Blue Splash": 176,
    "Blue Bloom": 175,
    "Purple": 174,
    "Light Blue": 173,
  ...
  "Body": {
    ...
    "Blue Sexy Bowling Shirt": 169,
    "Mario Overalls": 168,
    "Butthead Tee": 167,
    "Futuristic Armor": 166,
    "White and Green Jacket": 165,
    "Cowboy Jacket": 164,
    "Beavis Tee": 163,
    "Sexy Bowling Shirt": 162,
    "Super Ugly": 161,
    "Yellow Jersey": 160,
    "Rick Laser": 159,
    "UGS Jacket": 158,
    "Ugly Side of the Moon": 157,
    "Ugly Food Shirt": 156,
    "Acupuncture": 155,
    "Prison Tee": 154,
    "Cheerleader": 153,
    ...
    "Blue Wetsuit": 146,
    "Suit": 145,
    "Maple Leafs 1967 Tracksuit": 144,
    "Astronaut Blue": 143,
    "Maple Leafs 1967": 142,
    "Ugly Scene": 141,
    "Ninja": 140,
    "White and Blue Jacket": 139,
    "Hawaiian Shirt": 138,
    "Basketball Jersey": 137,
    "Purple Hoodie": 136,
    "Beige Fisherman Jacket": 135,
    "Pet Lover Bag": 134,
    "PAAF White Tee": 133,
    "Blue Baseball Jersey": 132,
    "Monster Tee Bag": 131,
    "Born Ugly Tee Tank": 130,
    "Tattooed Body": 129,
    "Black Puffy": 128,
    "Flame Tee Tank": 127,
    "Camo Wetsuit": 126,
    "Grey Fisherman Jacket": 125,
    "Ugly Army Tank": 124,
    "Borat": 123,
    "Sports Bra": 122,
    "Green Varsity": 121,
    "Beige Jacket": 120,
    "Holey Tee": 119,
    "Yellow Tracksuit": 118,
    "Long Sleeve Flame Tee": 117,
    "Bowling Shirt": 116,
    "Grey Bike Jersey": 115,
    "Light Green tee": 114,
    "White Ugly Tank": 113,
    "420Purple Tracksuit": 112,
    "Ugly Tank on Pink": 111,
    "Red BAseball Shirt": 110,
    "Purple Shirt": 109,
    "Gardener Overalls": 108,
    "Grease Tank": 107,
    "Yellow Puffy": 106,
    "Pink Jacket": 105,
    "Blue Overalls": 104,
  ...
  "Eyes": {
    ...
    "Sleepy Trio": 49,
    "Angry Cyclops": 48,
    "Angry Cyclops Lashes": 47,
    "Angry Trio": 46,
    "Angry Trio Lashes": 45,
    "Bionic Lashes": 44,
    "Cyclops": 43,
    "Cyclops Lashes": 42,
    "Trio Lashes": 41,
  ...
  "Head": {
    ...
    "Fiesta": 115,
    "Green Beanie": 114,
    "Yellow twintails": 112,
    "Blond Punk": 53
  },
  "Skin": {
    "Cristal": 220,
    "Cristal Elf": 219,
    "Purple Elf Space": 218,
    "Green Camo": 217,
    "Purple Space": 216,
    "Green Elf Camo": 215,
    "Green Elf": 214,
