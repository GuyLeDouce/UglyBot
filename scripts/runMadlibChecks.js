...
try{
  ...
  for(const test of ['testMadlibLogic','testMadlibTemplates','testMadlibIntegration','testMadlibDatabase']){
  ...
  result.featureVerification=result.feature.length===4&&result.feature.every(r=>r.status==='passed'&&r.testGroups>0)?'passed':'incomplete_or_failed';
